...
public class AlgorithmBenchmark {
    ...
    private final RateLimitAlgorithm token = new TokenBucketAlgorithm(new LocalRepository());
    private final RateLimitAlgorithm counter = new SlidingWindowCounterAlgorithm(new LocalRepository());
